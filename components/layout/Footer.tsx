...
const SOCIALS = [
  {
    label: 'WhatsApp',
    href: 'https://wa.me/2349153702941',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.117.553 4.103 1.518 5.829L.057 23.25a.75.75 0 00.916.916l5.42-1.461A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.695 9.695 0 01-4.953-1.356l-.355-.211-3.676.991.992-3.676-.211-.355A9.694 9.694 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
      </svg>
    ),
  },
  {
    label: 'Instagram',
    href: 'https://instagram.com/leadarxhq',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@leadarxhq',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/leadarx',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'X',
    href: 'https://twitter.com/leadarxhq',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <nav className="flex items-center gap-4" aria-label="Social media links">
            {SOCIALS.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="text-brand-grey hover:text-brand-light transition-colors duration-150"
              >
                {s.icon}
              </a>
            ))}
